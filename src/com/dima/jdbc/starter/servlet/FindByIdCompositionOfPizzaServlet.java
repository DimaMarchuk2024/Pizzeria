...
@WebServlet("/findByIdCompositionOfPizza")
public class FindByIdCompositionOfPizzaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        CompositionOfPizzaDto compositionOfPizzaDtoById = compositionOfPizzaService.findById(1L);
        resp.setContentType("text/html");
        try (PrintWriter writer = resp.getWriter()) {
            writer.write(compositionOfPizzaDtoById + " ");
        }
    }
}
